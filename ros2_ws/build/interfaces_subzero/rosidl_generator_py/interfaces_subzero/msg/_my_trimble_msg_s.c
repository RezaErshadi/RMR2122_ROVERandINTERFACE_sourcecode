...
bool interfaces_subzero__msg__my_trimble_msg__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("interfaces_subzero.msg._my_trimble_msg.MyTrimbleMsg", full_classname_dest, 51) == 0);
  }
  interfaces_subzero__msg__MyTrimbleMsg * ros_message = _ros_message;
  {  // gps_connection
  ...
  {  // gps_tel
    PyObject * field = PyObject_GetAttrString(_pymsg, "gps_tel");
    if (!field) {
      return false;
    }
    assert(PyUnicode_Check(field));
    ...
    rosidl_runtime_c__String__assign(&ros_message->gps_tel, PyBytes_AS_STRING(encoded_field));
    Py_DECREF(encoded_field);
    Py_DECREF(field);
  }
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * interfaces_subzero__msg__my_trimble_msg__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of MyTrimbleMsg */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("interfaces_subzero.msg._my_trimble_msg");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "MyTrimbleMsg");
  ...
  interfaces_subzero__msg__MyTrimbleMsg * ros_message = (interfaces_subzero__msg__MyTrimbleMsg *)raw_ros_message;
  {  // gps_connection
    PyObject * field = NULL;
  ...
  {  // gps_tel
    PyObject * field = NULL;
    field = PyUnicode_DecodeUTF8(
      ros_message->gps_tel.data,
      strlen(ros_message->gps_tel.data),
      "strict");
    if (!field) {
      return NULL;
    }
    {
      int rc = PyObject_SetAttrString(_pymessage, "gps_tel", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
