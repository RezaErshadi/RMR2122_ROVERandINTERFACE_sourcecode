...
bool interfaces_subzero__msg__my_garmin_msg__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("interfaces_subzero.msg._my_garmin_msg.MyGarminMsg", full_classname_dest, 49) == 0);
  }
  interfaces_subzero__msg__MyGarminMsg * ros_message = _ros_message;
  {  // gps_connection
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * interfaces_subzero__msg__my_garmin_msg__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of MyGarminMsg */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("interfaces_subzero.msg._my_garmin_msg");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "MyGarminMsg");
  ...
  interfaces_subzero__msg__MyGarminMsg * ros_message = (interfaces_subzero__msg__MyGarminMsg *)raw_ros_message;
  {  // gps_connection
    PyObject * field = NULL;
