...
bool interfaces_subzero__msg__rm_cmsg__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("interfaces_subzero.msg._rm_cmsg.RMCmsg", full_classname_dest, 38) == 0);
  }
  interfaces_subzero__msg__RMCmsg * ros_message = _ros_message;
  {  // msg
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * interfaces_subzero__msg__rm_cmsg__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of RMCmsg */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("interfaces_subzero.msg._rm_cmsg");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "RMCmsg");
  ...
  interfaces_subzero__msg__RMCmsg * ros_message = (interfaces_subzero__msg__RMCmsg *)raw_ros_message;
  {  // msg
    PyObject * field = NULL;
