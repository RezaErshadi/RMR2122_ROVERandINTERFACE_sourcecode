...
class Metaclass_R9sGPS(type):
    """Metaclass of message 'R9sGPS'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'interfaces_subzero.msg.R9sGPS')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__r9s_gps
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__r9s_gps
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__r9s_gps
            cls._TYPE_SUPPORT = module.type_support_msg__msg__r9s_gps
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__r9s_gps
...
class R9sGPS(metaclass=Metaclass_R9sGPS):
    """Message class 'R9sGPS'."""
