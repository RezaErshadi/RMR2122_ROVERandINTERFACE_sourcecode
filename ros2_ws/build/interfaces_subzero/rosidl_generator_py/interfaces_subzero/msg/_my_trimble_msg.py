...
class Metaclass_MyTrimbleMsg(type):
    """Metaclass of message 'MyTrimbleMsg'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'interfaces_subzero.msg.MyTrimbleMsg')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__my_trimble_msg
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__my_trimble_msg
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__my_trimble_msg
            cls._TYPE_SUPPORT = module.type_support_msg__msg__my_trimble_msg
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__my_trimble_msg
...
class MyTrimbleMsg(metaclass=Metaclass_MyTrimbleMsg):
    """Message class 'MyTrimbleMsg'."""
    ...
    def __init__(self, **kwargs):
        ...
        self.gps_tel = kwargs.get('gps_tel', str())
    ...
    @property
    def gps_tel(self):
        """Message field 'gps_tel'."""
        return self._gps_tel

    @gps_tel.setter
    def gps_tel(self, value):
        if __debug__:
            assert \
                isinstance(value, str), \
                "The 'gps_tel' field must be of type 'str'"
        self._gps_tel = value
