...
static const _SendString_Request_type_support_symbol_names_t _SendString_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interfaces_subzero, srv, SendString_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, interfaces_subzero, srv, SendString_Request)),
  }
};
...
{
  return &::interfaces_subzero::srv::rosidl_typesupport_cpp::SendString_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, interfaces_subzero, srv, SendString_Request)() {
  return get_message_type_support_handle<interfaces_subzero::srv::SendString_Request>();
}
...
static const _SendString_Response_type_support_symbol_names_t _SendString_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interfaces_subzero, srv, SendString_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, interfaces_subzero, srv, SendString_Response)),
  }
};
...
{
  return &::interfaces_subzero::srv::rosidl_typesupport_cpp::SendString_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, interfaces_subzero, srv, SendString_Response)() {
  return get_message_type_support_handle<interfaces_subzero::srv::SendString_Response>();
}
...
static const _SendString_type_support_symbol_names_t _SendString_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interfaces_subzero, srv, SendString)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, interfaces_subzero, srv, SendString)),
  }
};
...
{
  return &::interfaces_subzero::srv::rosidl_typesupport_cpp::SendString_service_type_support_handle;
}
