...
static const _MyGarminMsg_type_support_symbol_names_t _MyGarminMsg_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interfaces_subzero, msg, MyGarminMsg)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, interfaces_subzero, msg, MyGarminMsg)),
  }
};
...
{
  return &::interfaces_subzero::msg::rosidl_typesupport_cpp::MyGarminMsg_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, interfaces_subzero, msg, MyGarminMsg)() {
  return get_message_type_support_handle<interfaces_subzero::msg::MyGarminMsg>();
}
