...
#include "interfaces_subzero/msg/detail/r9s_gps__rosidl_typesupport_fastrtps_c.h"
...
using _R9sGPS__ros_msg_type = interfaces_subzero__msg__R9sGPS;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _R9sGPS__ros_msg_type * ros_message = static_cast<const _R9sGPS__ros_msg_type *>(untyped_ros_message);
  ...
  void * untyped_ros_message)
{
  ...
  _R9sGPS__ros_msg_type * ros_message = static_cast<_R9sGPS__ros_msg_type *>(untyped_ros_message);
  // Field name: gps_connection
  {
    uint8_t tmp;
    cdr >> tmp;
...
size_t get_serialized_size_interfaces_subzero__msg__R9sGPS(
  const void * untyped_ros_message,
...
static uint32_t _R9sGPS__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_interfaces_subzero__msg__R9sGPS(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_interfaces_subzero
size_t max_serialized_size_interfaces_subzero__msg__R9sGPS(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_interfaces_subzero__msg__R9sGPS(
    full_bounded, 0);
}


static message_type_support_callbacks_t __callbacks_R9sGPS = {
...
static rosidl_message_type_support_t _R9sGPS__type_support = {
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, interfaces_subzero, msg, R9sGPS)() {
  return &_R9sGPS__type_support;
}
