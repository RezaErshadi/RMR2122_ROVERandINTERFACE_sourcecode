...
#ifndef INTERFACES_SUBZERO__SRV__DETAIL__AP_RES_CONF__FUNCTIONS_H_
#define INTERFACES_SUBZERO__SRV__DETAIL__AP_RES_CONF__FUNCTIONS_H_
...
/// Initialize srv/ApRESConf message.
/**
...
/// Finalize srv/ApRESConf message.
/**
...
/// Create srv/ApRESConf message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * interfaces_subzero__srv__ApRESConf_Request__init().
...
/// Destroy srv/ApRESConf message.
/**
 * It calls
 * interfaces_subzero__srv__ApRESConf_Request__fini()
...
/// Initialize array of srv/ApRESConf messages.
/**
...
/// Finalize array of srv/ApRESConf messages.
/**
 * It calls
 * interfaces_subzero__srv__ApRESConf_Request__fini()
...
/// Create array of srv/ApRESConf messages.
/**
 * It allocates the memory for the array and calls
 * interfaces_subzero__srv__ApRESConf_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/ApRESConf messages.
/**
 * It calls
 * interfaces_subzero__srv__ApRESConf_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * interfaces_subzero__srv__ApRESConf_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_interfaces_subzero
...
/**
 * It calls
 * interfaces_subzero__srv__ApRESConf_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_interfaces_subzero
...
/**
 * It allocates the memory for the array and calls
 * interfaces_subzero__srv__ApRESConf_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_interfaces_subzero
...
/**
 * It calls
 * interfaces_subzero__srv__ApRESConf_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // INTERFACES_SUBZERO__SRV__DETAIL__AP_RES_CONF__FUNCTIONS_H_
