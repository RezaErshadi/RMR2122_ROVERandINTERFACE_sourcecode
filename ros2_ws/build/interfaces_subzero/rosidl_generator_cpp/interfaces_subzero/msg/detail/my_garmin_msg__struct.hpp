...
#ifndef INTERFACES_SUBZERO__MSG__DETAIL__MY_GARMIN_MSG__STRUCT_HPP_
#define INTERFACES_SUBZERO__MSG__DETAIL__MY_GARMIN_MSG__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__interfaces_subzero__msg__MyGarminMsg __attribute__((deprecated))
#else
# define DEPRECATED__interfaces_subzero__msg__MyGarminMsg __declspec(deprecated)
#endif
...
struct MyGarminMsg_
{
  using Type = MyGarminMsg_<ContainerAllocator>;

  explicit MyGarminMsg_(rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  {
  ...
  explicit MyGarminMsg_(const ContainerAllocator & _alloc, rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  : bpq_msg(_alloc),
    bpq_time(_alloc),
    gga_msg(_alloc),
    gga_time(_alloc),
  ...
  // pointer types
  using RawPtr =
    interfaces_subzero::msg::MyGarminMsg_<ContainerAllocator> *;
  using ConstRawPtr =
    const interfaces_subzero::msg::MyGarminMsg_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<interfaces_subzero::msg::MyGarminMsg_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<interfaces_subzero::msg::MyGarminMsg_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      interfaces_subzero::msg::MyGarminMsg_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<interfaces_subzero::msg::MyGarminMsg_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<interfaces_subzero::msg::MyGarminMsg_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<interfaces_subzero::msg::MyGarminMsg_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<interfaces_subzero::msg::MyGarminMsg_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__interfaces_subzero__msg__MyGarminMsg
    std::shared_ptr<interfaces_subzero::msg::MyGarminMsg_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__interfaces_subzero__msg__MyGarminMsg
    std::shared_ptr<interfaces_subzero::msg::MyGarminMsg_<ContainerAllocator> const>
  ...
  bool operator==(const MyGarminMsg_ & other) const
  {
...
using MyGarminMsg =
  interfaces_subzero::msg::MyGarminMsg_<std::allocator<void>>;
...
#endif  // INTERFACES_SUBZERO__MSG__DETAIL__MY_GARMIN_MSG__STRUCT_HPP_
