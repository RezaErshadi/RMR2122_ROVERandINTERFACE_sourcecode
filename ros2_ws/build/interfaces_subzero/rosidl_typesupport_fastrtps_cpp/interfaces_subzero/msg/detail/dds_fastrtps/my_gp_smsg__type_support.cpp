...
#include "interfaces_subzero/msg/detail/my_gp_smsg__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const interfaces_subzero::msg::MyGPSmsg & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: gps
  cdr << ros_message.gps;
  // Member: nmea
  cdr << ros_message.nmea;
  // Member: msg
  cdr << ros_message.msg;
  // Member: iqual
  cdr << ros_message.iqual;
  // Member: qual
  cdr << ros_message.qual;
  // Member: date
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  interfaces_subzero::msg::MyGPSmsg & ros_message)
{
  // Member: gps
  cdr >> ros_message.gps;
...
{
  auto typed_message =
    static_cast<const interfaces_subzero::msg::MyGPSmsg *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<interfaces_subzero::msg::MyGPSmsg *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _MyGPSmsg__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const interfaces_subzero::msg::MyGPSmsg *>(
...
{
  return max_serialized_size_MyGPSmsg(full_bounded, 0);
}

static message_type_support_callbacks_t _MyGPSmsg__callbacks = {
...
static rosidl_message_type_support_t _MyGPSmsg__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_MyGPSmsg__callbacks,
...
{
  return &interfaces_subzero::msg::typesupport_fastrtps_cpp::_MyGPSmsg__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interfaces_subzero, msg, MyGPSmsg)() {
  return &interfaces_subzero::msg::typesupport_fastrtps_cpp::_MyGPSmsg__handle;
}
