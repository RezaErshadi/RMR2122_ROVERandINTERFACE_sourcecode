...
#include "interfaces_subzero/msg/detail/my_garmin_msg__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const interfaces_subzero::msg::MyGarminMsg & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  interfaces_subzero::msg::MyGarminMsg & ros_message)
{
  // Member: gps_connection
  {
    uint8_t tmp;
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_interfaces_subzero
max_serialized_size_MyGarminMsg(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  auto typed_message =
    static_cast<const interfaces_subzero::msg::MyGarminMsg *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<interfaces_subzero::msg::MyGarminMsg *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _MyGarminMsg__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const interfaces_subzero::msg::MyGarminMsg *>(
...
{
  return max_serialized_size_MyGarminMsg(full_bounded, 0);
}

static message_type_support_callbacks_t _MyGarminMsg__callbacks = {
...
static rosidl_message_type_support_t _MyGarminMsg__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_MyGarminMsg__callbacks,
...
get_message_type_support_handle<interfaces_subzero::msg::MyGarminMsg>()
{
  return &interfaces_subzero::msg::typesupport_fastrtps_cpp::_MyGarminMsg__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interfaces_subzero, msg, MyGarminMsg)() {
  return &interfaces_subzero::msg::typesupport_fastrtps_cpp::_MyGarminMsg__handle;
}
