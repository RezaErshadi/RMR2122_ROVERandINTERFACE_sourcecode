...
import math
# Submodules
from subzero_v1.submodules.constrain import constrain
from subzero_v1.submodules.DeltaTime import DeltaTime
    ...
    def UpdateGPS(self, msg):
        try:
            ...
            if self.SurveyMode == "SAR" and self.SubDrive != "Wait":
                if self.DistFromLastRef >= self.sarSpacing-(self.sarSpacing*0.12):
